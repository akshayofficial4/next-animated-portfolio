    ...
    >
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <form
          onSubmit={sendEmail}
          ref={form}
          className=" h-1/2 lg:h-full lg:w-1/2 rounded-xl text-xl flex flex-col gap-8 justify-center md:p-24 lg:p-24 p-15  mb-16 "
        >
          <span>Dear Akshay</span>
          <textarea
            name="user_message"
            rows="3"
            className="block p-5 w-full text-sm bg-transparent border-b-2 border-b-black outline-none resize-none disabled:pointer-events-none "
          />
